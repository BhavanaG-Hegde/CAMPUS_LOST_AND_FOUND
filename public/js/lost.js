  ...
  if (!token) {
    form.innerHTML = `
      <div class="alert alert-warning">
        <i class="fas fa-exclamation-triangle"></i> You need to be logged in to report a lost item.
        <div class="mt-3">
  ...
  form.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        feedback.innerHTML = '<i class="fas fa-check-circle"></i> Lost item reported successfully!';
